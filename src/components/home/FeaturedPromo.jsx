...
const FeaturedVideos = () => {
  ...
  const CARD_HEIGHTS = {
    card1: '600px',      // Tall card on left
    card2: '300px',      // Top right card
    card3: '295px',      // Bottom left card
    card4: '295px',      // Bottom right card
    card5: '600px',      // Tall card on right
  };

  return (
    <section className="trending-products my-2">
