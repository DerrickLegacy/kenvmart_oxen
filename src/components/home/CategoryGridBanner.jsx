/**
 * CategoryGridBanner — compact brand showcase
 *
 * Layout: Featured hero image left | 4 brand chips right
 *
 * Fixes from user feedback:
 * - Much smaller height (hero 220px, chips 100px each)
 * - Images use objectFit:cover so they fill without distortion
 * - No excessive padding
 * - Brand colour (#183B9B) used for CTA buttons
 */
...
// Small brand chip — image fills the card, title + Shop Now pinned to bottom
    ...
    >
      ...
      <img
        ...
        style={{
          ...
          width:          '100%',
          height:         '100%',
          objectFit:      'cover',      // covers — no distortion
  ...
  return (
    <section style={{ padding: '16px 0 20px', background: '#f0f2f8' }}>
      <div className="container">
        ...
        {/* Main grid: hero left + 2×2 brand chips right */}
        <div style={{
          display:             'grid',
